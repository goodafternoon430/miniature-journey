...
Lecture 1: What is Quantum Computing? Binder
Lecture 2: Complex Numbers in Python Binder
Lecture 3: Vectors in Python Binder
Lecture 4: Inner Products and Unit Vectors Binder
Lecture 5: The Bloch Sphere and Representing Qubits Binder
Lecture 6: Tensor Products of Vectors in Python Binder
Lecture 7: Preparing Basis States in PennyLane Binder
Lecture 8: Matrices in Python Binder
Lecture 9: Tensor Products of Matrices in Python Binder
